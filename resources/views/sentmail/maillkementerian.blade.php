                    ...
                    <tr>
                        <td>
                            ...
                            <p>Berikut link reset password anda: <br><br>
                               ...
                               <a href="http://smart-cooperative.com/kementerian/login/change_password/{!! str_replace('@','%40', $email) !!}/{{$token}} ">http://smart-cooperative.com/kementerian/login/change_password/{{$email}}/{{ $token }}</a>
                                <br><br>
                                Anda memiliki waktu 5 menit sebelum request ini kadaluwarsa.<br>
