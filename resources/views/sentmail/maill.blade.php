                ...
                <table>
                    <tr>
                        <td>
                            ...
                            <p>Berikut link reset password anda: <br><br>


                               <a href="http://www.smart-cooperative.com/koperasi/user/change_password/{!! str_replace('@','%40', $email) !!}/{{$token}} ">http://www.smart-cooperative.com/koperasi/user/change_password/{{$email}}/{{ $token }}</a>
                                <br><br>
                                Anda memiliki waktu 10 menit sebelum request ini kadaluwarsa.<br>
                                Koperasi Modern password remainder. <br>
                                Thank you.<br>
                            </p>
